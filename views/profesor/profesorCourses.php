...
header("location:index.php?controller=Profesor&action=profesorLogin");
exit;
}
?>
...
echo "<form action='./index.php?controller=Profesor&action=profesorCourses' method='POST'>";
    ...
    while ($course_row = mysqli_fetch_array($courses)) {
        ...
        if (mysqli_num_rows($resultQuery) == 0) {
            ...
            if ($course_row['teacher_id'] == $_SESSION['id']) {
                ...
                echo "<td><a href='./index.php?controller=Profesor&action=profesorCourse&id_course=" . $course_row['id_course'] . "'>👁️</a>";
...
<a href="./index.php?controller=Profesor&action=profesorPanel" class="btn btn-primary">
    ◀️ Volver</a>